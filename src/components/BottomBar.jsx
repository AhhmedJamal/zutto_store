...
const BottomBar = () => {
  return (
    <ul className="md:hidden fixed bottom-0 btnBar bg-white border-t border-gray-300 w-full pl-2 container flex justify-around items-center h-16 pb-3 [box-shadow:0px_-1px_10px_0px_rgba(32,_32,_32,_0.176)]">
      <NavLink
        to="/"
